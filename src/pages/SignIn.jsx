          ...
          <form >
            ...
            <div className='relative mb-6'>
              <input
                ...
                className="w-full px-4 py-2 text-x1 text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"
              />
              {showPassword ? (
                <AiFillEyeInvisible
                  className='absolute right-3 top-3 text-x1
            cursor-pointer'
